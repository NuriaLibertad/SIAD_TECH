function App() {
  ...
  const [rotas, setRotas] = React.useState(rotasIniciais);
  const [mostrarFormulario, setMostrarFormulario] = React.useState(false);
  const [novaRota, setNovaRota] = React.useState({
    origem: "",
    destino: "",
    alimento: "",
    status: "Coleta"
  ...
  function cadastrarRota(evento) {
    ...
    const rota = {
      ...novaRota,
      etapa: novaRota.status === "Entregue" ? 4 : novaRota.status === "Urgente" ? 2 : 0
    };
  ...
  return (
    <>
      <header className="cabecalho">
        <nav className="navbar navbar-expand-lg">
          <div className="container">
            <a className="navbar-brand logo-area" href="index.html">
              <img src="assets/logo.svg" className="logo-img" alt="Logo SIAD Tech" />
            ...
            <div className="collapse navbar-collapse" id="menu">
              <ul className="navbar-nav ms-auto">
                ...
                <li className="nav-item"><a className="nav-link" href="index.html#doar">Doações + ONGs</a></li>
                <li className="nav-item"><a className="nav-link ativo" href="transportes.html">Transportes</a></li>
                <li className="nav-item"><a className="nav-link link-contato" href="#contato">Fale Conosco</a></li>
              </ul>
            </div>
          </div>
        </nav>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-md-6">
                ...
                <h1>TRANSPORTES</h1>
                <p>
                  O meio de transporte é fundamental para garantir um processo eficiente
                  desde a coleta até a distribuição dos alimentos. Inspirada em iniciativas
                  como a GoodTruck Brasil, esta tela ajuda a organizar rotas, destinos e
                  entregas para ONGs e famílias em vulnerabilidade social.
                </p>

                <button className="botao-rosa" onClick={() => setMostrarFormulario(!mostrarFormulario)}>
                  Nova rota
                </button>
              </div>
          ...
          <section className="secao">
            <div className="container">
              <form className="formulario-rota" onSubmit={cadastrarRota}>
                ...
                <div className="row g-3">
                  ...
                  <div className="col-md-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setNovaRota({ ...novaRota, alimento: e.target.value })}
                  ...
                  <div className="col-md-3">
                    ...
                    <select
                      ...
                      onChange={(e) => setNovaRota({ ...novaRota, status: e.target.value })}
                    >
                ...
                <button className="botao-rosa mt-4" type="submit">Salvar rota</button>
              </form>
            </div>
          </section>
        )}
            ...
            <div className="row g-4">
              <div className="col-md-5">
                <div className="cartao-explicacao">
                  ...
                  <p>
                    Essa explicação muda quando você clica em cada etapa do fluxo,
                    deixando a tela mais dinâmica e fácil de apresentar.
                  </p>
                </div>
              </div>
      ...
      <footer>
        <p>SIAD Tech - Transporte solidário contra o desperdício de alimentos.</p>
      </footer>
    </>
  );
}
